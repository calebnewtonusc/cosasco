...
export default function CareersPage() {
  const cultureCards = [
    ...
    },
    {
      ...
      title: "Global Reach",
      desc: "Work alongside colleagues and customers across six continents. Cosasco operates in over 60 countries, offering true international exposure.",
    },
    {
  ...
  return (
    <main>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-[#0f2a4a]">Why Work at Cosasco?</h2>
      ...
      <section className="bg-[#f7f9fc] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#0f2a4a]">Current Openings</h2>
            <p className="text-[#6b7280] mt-3">Explore opportunities across our global organization.</p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-[#0f2a4a]">Benefits & Perks</h2>
            <p className="text-[#6b7280] mt-3 max-w-xl mx-auto">
      ...
      <section className="bg-[#0f2a4a] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Don&apos;t see a perfect fit?</h2>
