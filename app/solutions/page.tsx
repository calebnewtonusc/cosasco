...
export const metadata: Metadata = {
  title: 'Industry Solutions | Cosasco',
  description:
    ...
    <div className="min-h-screen bg-white">
      <section className="relative bg-[#0f2a4a] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-16 md:py-20">
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight mb-4">
            Corrosion Programs Built for Your Industry
          </h1>
          <p className="text-[#94aabb] text-lg max-w-2xl">
            Real-time corrosion monitoring and management solutions tailored to your sector. Cosasco serves six primary industries worldwide.
          </p>
          <div className="flex flex-wrap gap-4 mt-8">
            <Link href="/industry" className="inline-flex items-center gap-2 bg-[#f4a65d] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-[#d4892a] transition-colors">
              View all industries
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/contact" className="inline-flex items-center gap-2 border border-white/50 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-white/10 transition-colors">
              Contact us
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((ind, idx) => (
            ...
            >
              <p className="text-[#f4a65d] text-xs font-bold tracking-wider mb-2">{String(idx + 1).padStart(2, '0')}</p>
              <h2 className="font-black text-[#0f2a4a] text-xl group-hover:text-[#f4a65d] transition-colors mb-2">
                {ind.name}
              </h2>
              <p className="text-[#566677] text-sm leading-relaxed flex-1">{ind.tagline}</p>
              <span className="text-[#f4a65d] text-sm font-semibold inline-flex items-center gap-1 mt-4 group-hover:gap-2 transition-all">
                View industry
                <ArrowRight className="w-4 h-4" />
              </span>
            </Link>
      ...
      <section className="bg-[#f7f9fc] py-16 border-t border-[#e8edf2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          <h2 className="text-2xl font-black text-[#0f2a4a] mb-4">Not sure where to start?</h2>
          <p className="text-[#566677] max-w-xl mx-auto mb-8">
            Our application engineers can recommend the right monitoring strategy for your process.
          </p>
