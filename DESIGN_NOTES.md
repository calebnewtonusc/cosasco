...
- When at top: `bg-white border-transparent` — clean, borderless against hero sections
...
| Form AnimatePresence | Smooth idle→success transitions | 🔲 Requires framer-motion |
