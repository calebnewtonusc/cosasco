  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#0f2a4a] text-white overflow-hidden">
        ...
        <div className="cx relative py-20 md:py-28">
          <div className="max-w-3xl">
            <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#e05000] mb-2">About Cosasco</p>
      ...
      <section className="bg-white py-16 border-b border-[#e8edf2]">
        <div className="cx">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((s) => (
              <div key={s.label}>
                <div className="text-[#e05000] font-black text-5xl leading-none mb-2">{s.value}</div>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="cx">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            {/* Text left */}
            <div>
              <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#e05000] mb-3">Our Story</p>
            ...
            <div className="relative">
              <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-[#e05000] to-[#0f2a4a]" aria-hidden="true" />
              <div className="space-y-6 pl-12">
                {timeline.map((item, idx) => (
                  <div key={item.year} className="relative">
                    <div
                      className="absolute -left-[2.15rem] top-1.5 w-3 h-3 rounded-full bg-[#e05000] border-2 border-white shadow"
                      aria-hidden="true"
                    />
                    <div className="bg-white border border-[#e8edf2] rounded-xl p-4 hover:border-[#e05000] transition-colors">
                      <span className="inline-block text-[#e05000] text-xs font-black tracking-wider mb-1">{item.year}</span>
      ...
      <section className="bg-[#f7f9fc] py-20 md:py-24">
        <div className="cx">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#e05000] mb-3">Who We Are</p>
            ...
            {values.map((v) => {
              ...
              return (
                <div key={v.title} className="bg-white border border-[#e8edf2] rounded-xl p-8">
                  <div className="border-l-4 border-[#e05000] pl-5 mb-6">
                    <h3 className="font-black text-[#0f2a4a] text-xl">{v.title}</h3>
                  </div>
                  <div className="w-10 h-10 bg-[#e05000]/10 rounded-xl flex items-center justify-center mb-4">
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="cx">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#e05000] mb-3">Quality Assurance</p>
            <h2 className="text-3xl md:text-4xl font-black text-[#0f2a4a] mb-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {certifications.map((cert) => (
              <div key={cert.name} className="bg-white border border-[#e8edf2] rounded-xl p-6 hover:shadow-lg hover:border-[#e05000] transition-all">
                <div className="flex items-start gap-4">
                  <div className="w-9 h-9 bg-[#e05000]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Award className="w-4 h-4 text-[#e05000]" />
                  </div>
                  <div>
      ...
      <section className="bg-[#0f2a4a] text-white py-16">
        <div className="cx">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#e05000] mb-4">Headquarters</p>
            ...
            <div className="space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <Factory className="w-7 h-7 text-[#e05000] flex-shrink-0 mt-0.5" />
                  <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <Globe className="w-7 h-7 text-[#e05000] flex-shrink-0 mt-0.5" />
                  <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <CheckCircle className="w-7 h-7 text-[#e05000] flex-shrink-0 mt-0.5" />
                  <div>
