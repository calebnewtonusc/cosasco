          ...
          >
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-xs font-semibold mb-1.5" style={{ color: '#374151' }}>
                    Full Name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label htmlFor="company" className="block text-xs font-semibold mb-1.5" style={{ color: '#374151' }}>
                    Company
                  </label>
                  <input
                    id="company"
              ...
              <div>
                <label htmlFor="email" className="block text-xs font-semibold mb-1.5" style={{ color: '#374151' }}>
                  Work Email
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="industry" className="block text-xs font-semibold mb-1.5" style={{ color: '#374151' }}>
                  Industry
                </label>
                <select
                  id="industry"
              ...
              <div>
                <label htmlFor="challenge" className="block text-xs font-semibold mb-1.5" style={{ color: '#374151' }}>
              ...
              <button
                type="submit"
                className="w-full font-semibold py-3 rounded-lg mt-2 text-white transition-colors hover:bg-[#d4892a]"
